...
@FacesValidator(value = "regexValidatorEmail")
public class RegexValidatorEmail implements Validator{
	...
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
		...
		if(!isValid(regex,valor)){
			String mensagem = "O campo <strong>%s</strong> não contem um email válido.";
